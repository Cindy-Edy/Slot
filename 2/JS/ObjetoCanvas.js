...
ObjetoCanvas.prototype.IniciarObjetoCanvas = function() {
    ...
    if (this.OpcionesCanvas['Entorno'] === 'Normal') {
        ...
        if (this.OpcionesCanvas.BotonLogo === true) {
            StrHtml +=  "<a href='./img.jpg' class='ObjetoCanvas_Boton' target='_blank' title='"+ this.Textos[this.OpcionesCanvas.Idioma][6] +"' id='ObjetoCavas_Logo'>" +
                    "<img src='./img.jpg' />" +
                    "<div id='ObjetoCavas_TextoLogo'>" +
                        "<span>D</span>" + "<span>O</span>" + "<span>M</span>" + "<span>I</span>" + "<span>N</span>" + "<span>O</span>"
                    "</div>" +
                "</a>";
        }        
        StrHtml += "</div>";
